...
typedef struct _tBLEProfileGlobalContext
{
   ...
   */
  tConnUpdateContext_t ConnUpdateContext;
...
#define CONN_UPDATE_TIMEOUT            (500*1000/CFG_TS_TICK_VAL) /**< 500ms */
/* USER CODE END PD */
...
void APP_BLE_Init(void)
{
  ...
  BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle = 0xFFFF;
  BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionInterval = 0;
  BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionPhy = 0;
  ...
  /* Create timer to handle connection interval update request */
  HW_TS_Create(CFG_TIM_PROC_ID_ISR, &(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.Update_conn_timer_Id), hw_ts_SingleShot, Conn_Update);
   ...
   */
  Adv_Request(APP_BLE_LP_ADV); /* low power advertising from the beginning */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      if (p_disconnection_complete_event->Connection_Handle == BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle)
      {
        BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle = 0;
        BleApplicationContext.Device_Connection_Status = APP_BLE_IDLE;
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_PHY_UPDATE_COMPLETE_SUBEVT_CODE:
          ...
          ret = hci_le_read_phy(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle, &Tx_phy, &Rx_phy);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle = p_connection_complete_event->Connection_Handle;
          
          /* Start timer to change connection interval in order to reduce power consumption */
          HW_TS_Start(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.Update_conn_timer_Id, CONN_UPDATE_TIMEOUT);
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_GAP_PASS_KEY_REQ_VSEVT_CODE:  
          ...
          ret = aci_gap_pass_key_resp(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle,123456);
          if (ret != BLE_STATUS_SUCCESS)
          {
        ...
        case ACI_GAP_AUTHORIZATION_REQ_VSEVT_CODE:    
          ...
          ret = aci_gap_allow_rebond(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle);
          if (ret != BLE_STATUS_SUCCESS)
          {
        ...
        case (ACI_GAP_NUMERIC_COMPARISON_VALUE_VSEVT_CODE):
          ...
          APP_DBG_MSG("     - Hex_value = %lx\n",
                      ((aci_gap_numeric_comparison_value_event_rp0 *)(p_blecore_evt->data))->Numeric_Value);
          ret = aci_gap_numeric_comparison_value_confirm_yesno(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle, YES); /* CONFIRM_YES = 1 */
          if (ret != BLE_STATUS_SUCCESS)
          {
        ...
        case ACI_GATT_INDICATION_VSEVT_CODE:
        {
          ...
          aci_gatt_confirm_indication(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle);
        }
        break;
...
void BLE_SVC_L2CAP_Conn_Update(uint16_t ConnectionHandle)
{
  ...
  /* USER CODE END BLE_SVC_L2CAP_Conn_Update_1 */
    ...
    uint16_t interval_min = CONN_P(LP_CONN_INTERVAL_MIN);
    uint16_t interval_max = CONN_P(LP_CONN_INTERVAL_MAX);
    uint16_t peripheral_latency = L2CAP_PERIPHERAL_LATENCY;
    uint16_t timeout_multiplier = L2CAP_TIMEOUT_MULTIPLIER;
    tBleStatus ret;

    ret = aci_l2cap_connection_parameter_update_req(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle,
...
static void Connection_Interval_Update_Req(void)
{
  ...
  {
    BLE_SVC_L2CAP_Conn_Update(BleApplicationContext.BleApplicationContext_legacy.ConnUpdateContext.connectionHandle);
  }
