...
#define L2CAP_TIMEOUT_MULTIPLIER         500

#define LP_CONN_INTERVAL_MIN            CONN_P(1050)
#define LP_CONN_INTERVAL_MAX            CONN_P(1500)
...
typedef enum
{
  ...
  CFG_TASK_HTS_MEAS_START_REQ_ID,
  CFG_TASK_HTS_MEAS_PROCESS_REQ_ID,
